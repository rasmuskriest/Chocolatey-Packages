...
$packageName = 'physx.legacy' # arbitrary name for the package, used in messages
$installerType = 'msi' #only one of these: exe, msi, msu
$url = 'http://in.download.nvidia.com/Windows/9.12.1031/PhysX-9.12.1031-SystemSoftware-Legacy.msi' # download url
$silentArgs = '/quiet /qn' # "/s /S /q /Q /quiet /silent /SILENT /VERYSILENT" # try any of these to get the silent installer #msi is always /quiet
